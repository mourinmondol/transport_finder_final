                ...
                <div class="table-fix">
                    <table class="table-edit" >
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="{{route('transport_edit_user',$transport->id)}}" class="btn btn-primary btn-mini"><i class="icon-edit icon-white"></i>E</a>
                            <a onclick="return confirm('Are you sure you want to delete this item?');" href="{{route('transport_delete_user',$transport->id)}}" class="btn btn-danger btn-mini"><i class="icon-remove icon-white"></i>X</a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
        ...
        <div class="col-md-5">
            <div class="well">
                ...
                @else
                    <h4>Add Transport </h4>
                @endif
                <form action="@if(isset($transportEditInfo)) {{ route ('transport_update_user',['id'=>$transportEditInfo->id]) }} @else {{route('user.store.transport')}} @endif" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}

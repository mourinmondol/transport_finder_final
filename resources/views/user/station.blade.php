                ...
                <div class="table-fix">
                    <table class="table-edit" >
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="{{route('station_edit_user',$station->id)}}" class="btn btn-primary btn-mini"><i class="icon-edit icon-white"></i>E</a>
                            <a onclick="return confirm('Are you sure you want to delete this item?');" href="{{route('station_delete_user',$station->id)}}" class="btn btn-danger btn-mini"><i class="icon-remove icon-white"></i>X</a>
                            </td>
                        </tr>
                        @endforeach
                    </table>
        ...
        <div class="col-md-5">
            <div class="well">
                ...
                @else
                    <h4>Add Station </h4>
                @endif
                <form action="@if(isset($stationEditInfo)) {{ route ('station_update_user',['id'=>$stationEditInfo->id]) }} @else {{route('user.store.station')}} @endif" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
